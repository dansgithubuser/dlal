...
int main(int argc, char** argv){
	...
	vector<pair<float, float> > pitches;///
	//pitches.push_back(pair<float, float>(1.25f, 0.5f));
	pitches.push_back(pair<float, float>(1.5f, 0.25f));
	pitches.push_back(pair<float, float>(1.25f, 0.25f));
	//pitches.push_back(pair<float, float>(1.0f, 0.25f));
	//pitches.push_back(pair<float, float>(2.0f, 0.5f));
